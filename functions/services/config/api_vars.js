...
export const SESSION_ABSOLUTE_DURATION_DAYS =31;
...
export const PROVIDER_AUTH_KEY_PREFIX ="provider_auth_id:";
export const ACCOUNT_LOGIN_STATE_KEY_PREFIX ="account_login_status:";
export const PROVIDER_AUTH_DURATION_DAYS =31;
export const LOGIN_GAP_DURATION_DAYS =10;
export const PROVIDER_AUTH_TTL_SECONDS =PROVIDER_AUTH_DURATION_DAYS* 24* 60* 60;
export const REFRESH_GATE_TTL_SECONDS = 24 * 60 * 60;
export const LATEST_MMR_VERIFY_INTERVAL_SECONDS = 24 * 60 * 60;